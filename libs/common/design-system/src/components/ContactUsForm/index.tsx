        ...
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden py-10 px-6 bg-yellow-400 sm:px-10 xl:p-12">
              ...
              <h3 className="text-lg font-medium text-black">Atención a clientes</h3>
              <p className="mt-6 text-base text-black max-w-3xl">
              Estaremos encantados de atenderte, envíanos tus comentarios, dudas o sugerencias completando el formulario a continuación.
              </p>
              <dl className="mt-8 space-y-6">
                <dt>
                  <span className="sr-only">Número telefónico</span>
                </dt>
                <dd className="flex text-base text-indigo-50">
                  <PhoneIcon className="flex-shrink-0 w-6 h-6 text-black" aria-hidden="true" />
                  <span className="ml-3 text-black">55 2770 0843</span>
                </dd>
                <dt>
                ...
                <li>
                  <a className="text-black hover:text-gray-500" href="https://www.instagram.com/cinicamx">
                    ...
                    <svg
                      ...
                      aria-hidden="true"
                    >
                      <path fill="currentColor" d="M14.52,2.469H5.482c-1.664,0-3.013,1.349-3.013,3.013v9.038c0,1.662,1.349,3.012,3.013,3.012h9.038c1.662,0,3.012-1.35,3.012-3.012V5.482C17.531,3.818,16.182,2.469,14.52,2.469 M13.012,4.729h2.26v2.259h-2.26V4.729z M10,6.988c1.664,0,3.012,1.349,3.012,3.012c0,1.664-1.348,3.013-3.012,3.013c-1.664,0-3.012-1.349-3.012-3.013C6.988,8.336,8.336,6.988,10,6.988 M16.025,14.52c0,0.831-0.676,1.506-1.506,1.506H5.482c-0.831,0-1.507-0.675-1.507-1.506V9.247h1.583C5.516,9.494,5.482,9.743,5.482,10c0,2.497,2.023,4.52,4.518,4.52c2.494,0,4.52-2.022,4.52-4.52c0-0.257-0.035-0.506-0.076-0.753h1.582V14.52z"></path>
                    </svg>
                  </a>
                </li>
                <li>
            ...
            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              <h3 className="text-lg font-medium text-gray-900">Envíanos tus comentarios</h3>
              <form method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8" onSubmit={handleSubmit}>
                <div>
                ...
                <div className="sm:col-span-2 sm:flex sm:justify-end">
                  <button
                    type="submit"
                    className="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto"
                  >
                    Enviar
                  </button>
                </div>
              ...
              {displayResultModal && (
                ...
                <div className="flex flex-col w-full px-20 mb-4 -mt-10 justify-center items-center">
                    ...
                    <p className="text-2xl text-center mb-4">{feedbackMessage}</p>
                </div>
                </Modal>
              )}
            </div>
